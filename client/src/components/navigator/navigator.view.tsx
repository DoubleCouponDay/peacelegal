    ...
    <nav>
      ...
      <div className="buttons-container">
        <Link
          ...
          onMouseUp={() => mouseup()}
        >
          <img className="icon" src={talksymbol} /> Services
        </Link>
        ...
        <Link
          ...
          onMouseUp={() => mouseup()}
        >
          <img className="icon" src={passportsymbol} />
          Fees
        </Link>
        ...
        <Link
          ...
          onMouseUp={() => mouseup()}
        >
          <img className="icon" src={mailsymbol} />
          Contact
        </Link>
      </div>
    </nav>
